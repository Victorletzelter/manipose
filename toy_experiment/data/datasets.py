...
class LiftingDatasetV2:
    def __init__(
        ...
        # Sample training, validation and test data ONCE and convert to torch
        self.X_train, self.Y_train = to_torchV2(*distribution.sample(n_train))
        self.X_val, self.Y_val = to_torchV2(*distribution.sample(n_val))
        self.X_test, self.Y_test = to_torchV2(*distribution.sample(n_test))
